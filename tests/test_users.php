...
class WPL_Test_Users extends WP_UnitTestCase
{
	...
	function setUp()
	{
		...
		include_once WORDPRESS_PIXELPIN_LOGIN_ABS_PATH . 'hybridauth/Hybrid/User_Profile.php';
	...
	*/
	...
	/*
	* make sure users pixelpin profiles setter and getters works correctly
	*/
	...
	/*
	* make sure users pixelpin profiles are deleted when the associated wordpress user is deleted
	*/

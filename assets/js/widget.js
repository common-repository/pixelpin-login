...
*
* Based on http://wordpress.org/extend/plugins/pixelpin-connect/
*/
...
(function($){ 
	$(function(){ 
		$(document).on( 'click', 'a.wp-pixelpin-login-provider', function(){
			...
			window.open( popupurl + 'provider=' + provider, 'hybridauth_pixelpin_sing_on', 'location=1,status=0,scrollbars=0,height=' + height + ',width=' + width + ',top=' + top + ',left=' + left);
		});
	});
})(jQuery);

	...
	public function getAccessToken()
	{
		...
		return
			ARRAY(
				...
				"expires_at"          => $this->adapter->token( "expires_at" )         , // OPTIONAL. Timestamp when the access_token expire. if not provided by the pixelpin api, then it should be calculated: expires_at = now + expires_in
			);
	}

 ...
 * 
 * used to provider the connected user activity stream on a standardized structure across supported pixelpin apis.
 * 
...
class Hybrid_User_Activity
{
	...
	public function __construct()
	{
		...
		// typically, we should have a few information about the user who created the event from pixelpin apis
